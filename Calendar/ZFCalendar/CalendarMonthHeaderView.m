...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.f, 0.0f, SCREEN_WIDTH, 30.f)];
    ...
    CGFloat margin = (SCREEN_WIDTH - 280)/6;
    //一，二，三，四，五，六，日
    ...
    xOffset += CATDayLabelWidth + margin;
    ...
    xOffset += CATDayLabelWidth + margin-5;
    dayOfTheWeekLabel = [[UILabel alloc]initWithFrame:CGRectMake(xOffset,yOffset, CATDayLabelWidth - 5, CATDayLabelHeight)];
    [dayOfTheWeekLabel setBackgroundColor:[UIColor clearColor]];
    [dayOfTheWeekLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:15.0f]];
